...
public class LrcView extends android.widget.TextView {
    ...
    private float textHeight = 24;  //文本高度  
    private float textSize = 16;        //文本大小  
    ...
    public LrcView(Context context) {
        super(context);
        init();
        // this.setBackgroundResource(R.drawable.bglrc);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        DisplayMetrics dm = this.getResources().getDisplayMetrics();
        currentPaint.setTextSize((int) (textSize * dm.density+5));
        currentPaint.setTypeface(Typeface.SERIF);

        notCurrentPaint.setTextSize((int) (textSize * dm.density));
        ...
        try {
            ...
            for (int i = index - 1; i >= 0; i--) {
                //向上推移  
                tempY = tempY - (int) (textHeight * dm.density);
